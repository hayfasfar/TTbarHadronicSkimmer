...
from corrections import GetL1PreFiringWeight, GetPDFWeights, GetPUSF, GetQ2weights, pTReweighting
    ...
    def build_weights(self, dataset, events, evtweights, is_data, jet0, jet1, ttag2, antitag):
        ...
        if ("prefiring" in self.systematics) and ("L1PreFiringWeight" in events.fields):
            if ("2016" in self.iov) or ("2017" in self.iov):
                ...
                weights.add("prefiring", weight=prefiringNom, weightUp=prefiringUp, weightDown=prefiringDown)
